...
export const Accordion: FC<AccordionProps> = ({
  ...
  return (
    <div
      className={classNames(className, readMore ? '' : 'border-bottom--gray')}
    >
                    ...
                    {cta && (
                      <div className="cta w-full relative mt-y">
                        <SanityLink
                          ...
                          className="w-full md:max-w-[var(--btn-width)] border-1 border-black hover:border-white border-solid flex flex-row justify-between items-center bg-black text-white hover:invert text-button z-above px-4 py-3.5"
                        >
